...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{@{}lX@{}}
    ...
    Hasła & BCrypt (\texttt{PasswordEncoder}); reset hasła staff (EMPLOYEE, MANAGER) --- losowe hasło tymczasowe e-mailem. \\
...
\begin{itemize}[noitemsep]
  ...
  \item reset hasła staff --- EMPLOYEE i MANAGER (\texttt{EmployeePasswordResetMvcTest}).
\end{itemize}
