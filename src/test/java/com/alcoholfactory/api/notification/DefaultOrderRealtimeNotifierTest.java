...
class DefaultOrderRealtimeNotifierTest {
    ...
    @Mock
    FcmStaffOrderPushService fcmPush;

    @Mock
    DeliveryRepository deliveryRepository;

    @InjectMocks
    DefaultOrderRealtimeNotifier notifier;
    ...
    void onOrderCreated_notifiesCustomerStaffAndFcm() {
        ...
        verify(fcmPush).notifyStaffRoles(
    ...
    void onOrderStatusChanged_inDelivery_publishesDispatchTopic() {
        ...
        verify(messagingTemplate).convertAndSend(eq(OrderRealtimeDestinations.DISPATCH_TOPIC), captor.capture());
