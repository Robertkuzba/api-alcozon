...
public class TestDataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        productId = productStockRepository.findAll().stream()
    ...
    private void seedUser(String email, String password, UserRole role, boolean courier, Instant ageConfirmedAt) {
