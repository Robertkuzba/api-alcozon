...
public final class AuthTestClient {
  ...
  public static Tokens staffLogin(MockMvc mockMvc, String email, String password, String deviceId)
      throws Exception {
    String body =
        """
    ...
    MvcResult loginResult =
        mockMvc
            .perform(
                post("/api/auth/staff/login").contentType(MediaType.APPLICATION_JSON).content(body))
            .andExpect(status().isOk())
            .andReturn();
