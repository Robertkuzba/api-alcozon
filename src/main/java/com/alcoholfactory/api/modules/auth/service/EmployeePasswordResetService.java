...
public class EmployeePasswordResetService {
  ...
  /**
   * Reset hasła dla aktywnego użytkownika z rolą {@link UserRole#EMPLOYEE} lub {@link
   * UserRole#MANAGER}. Zawsze kończy się bez wyjątku (kontroler zwraca 204), także gdy e-mail nie
   * istnieje lub rola jest inna — bez ujawniania, czy konto jest w systemie.
   */
  @Transactional
  ...
  private void applyReset(User user) {
    String plain =
        passwordResetProperties.useFixedPassword()
