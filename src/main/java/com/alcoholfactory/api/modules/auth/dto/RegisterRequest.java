...
public record RegisterRequest(
    ...
    @NotBlank
        @Pattern(
            regexp = ValidationPatterns.PASSWORD_STRONG,
            message = "Password must be 8+ chars with upper, lower, digit and special")
        String password,
    ...
    @Pattern(regexp = ValidationPatterns.SAFE_TEXT, message = "Invalid characters in last name")
        @Size(max = 100)
        String lastName,
    @NotNull(message = "ageConfirmed is required") Boolean ageConfirmed) {
