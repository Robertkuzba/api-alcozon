...
public record DeliveryDetailsRequest(
        @NotBlank
        @Pattern(regexp = ValidationPatterns.SAFE_TEXT, message = "Invalid characters in recipient name")
        @Size(max = 200)
        String recipientName,
        @NotBlank
        @Pattern(regexp = ValidationPatterns.SAFE_TEXT, message = "Invalid characters in street address")
        @Size(max = 500)
        ...
        @Size(max = 100)
        String country,
        @Pattern(regexp = ValidationPatterns.SAFE_TEXT, message = "Invalid characters in delivery notes")
        @Size(max = 2000)
        String deliveryNotes,
        @Pattern(regexp = ValidationPatterns.SAFE_TEXT, message = "Invalid characters in payment method")
        @Size(max = 100)
