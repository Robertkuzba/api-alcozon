...
public class OrderController {
  ...
  public CombinedOrdersResponse forCourier(
      @PathVariable @Positive Long courierUserId, @AuthenticationPrincipal AppUserDetails user) {
  ...
  public OrderResponse get(@PathVariable String id, @AuthenticationPrincipal AppUserDetails user) {
  ...
  public OrderResponse patchStatus(
      @PathVariable Long id, @Valid @RequestBody PatchOrderStatusRequest request) {
  ...
  public OrderResponse cancel(
      @PathVariable String id, @AuthenticationPrincipal AppUserDetails user) {
