...
public class ProductService {
    ...
    public Page<ProductResponse> search(String q, String category, BigDecimal minPrice, BigDecimal maxPrice, Pageable pageable) {
    ...
    public ProductResponse create(CreateProductRequest req) {
        ...
        ProductStock stock = ProductStock.builder()
                .product(p)
                .quantity(Math.max(0, req.initialStock()))
                .build();
    ...
    private ProductResponse toResponse(Product p) {
        int stock = productStockRepository.findById(p.getId())
