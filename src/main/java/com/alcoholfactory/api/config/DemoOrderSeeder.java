...
/**
 * Dane demo dla mobilki / desktopu (Michał, Bartek). Idempotentne: pomija seed, gdy istnieje
 * zamówienie {@code 701101}.
 */
@Component
@Profile("!test")
@Order(2)
...
public class DemoOrderSeeder implements CommandLineRunner {
  ...
  private void seedPrimaryDemoOrders() {
            ...
            .orElseThrow(
                () ->
                    new IllegalStateException(
                        "Brak "
                            + EMPLOYEE_EMAIL
                            + " — uruchom DataInitializer (manager/employee)"));
    ...
    createOrder(
        ...
        base.plus(1, ChronoUnit.DAYS).plus(15, ChronoUnit.MINUTES),
        null);
    ...
    createOrder(
        ...
        base.plus(1, ChronoUnit.DAYS).plus(30, ChronoUnit.MINUTES),
        null);
    ...
    createOrder(
        ...
        base.plus(1, ChronoUnit.DAYS).plus(45, ChronoUnit.MINUTES),
        null);
    ...
    createOrder(
        ...
        base.plus(2, ChronoUnit.DAYS).plus(20, ChronoUnit.MINUTES),
        null);
    ...
    createOrder(
        ...
        base.plus(2, ChronoUnit.DAYS).plus(2, ChronoUnit.HOURS),
        deliveredAt);
  ...
  private void seedBartekPendingDeliveries() {
    ...
    createOrder(
        ...
        DeliveryStatus.PENDING,
        address(
            "Pending seed 2", "ul. Oczekujaca 2", "Wrocław", "50-102", "Druga PENDING dla Desktop"),
  ...
  private void seedBartekDesktopDeliveries() {
    ...
    createOrder(
        ...
        null,
        DeliveryStatus.PENDING,
        address("Desktop seed B", "ul. Bartka 2", "Wrocław", "50-002", "Druga dostawa bez kuriera"),
        ...
        .orElseGet(
            () ->
                productRepository.findAll().stream()
                    ...
                    .findFirst()
                    .orElseThrow(
                        () -> new IllegalStateException("Brak produktu do seedu zamówień")));
  }
          ...
          Delivery.builder()
              ...
              .startedAt(
                  deliveryStatus == DeliveryStatus.IN_TRANSIT
                      ? createdAt.plus(1, ChronoUnit.HOURS)
                      : null)
              .deliveredAt(deliveredAt)
              .build();
  ...
  private static OrderDeliveryDetails address(
      String recipient, String street, String city, String postalCode) {
    return address(recipient, street, city, postalCode, null);
  }

  private static OrderDeliveryDetails address(
      String recipient, String street, String city, String postalCode, String notes) {
